        ...
        <div className="relative flex h-full flex-col">
          ...
          <div className="px-3 pb-3 pt-4">
            <NavLink
              to="/"
              className="
                flex items-center justify-center gap-3 rounded-[26px]
            ...
            >
              ...
              <div className="min-w-0 flex-1 overflow-hidden">
                <div className="pointer-events-none w-0 overflow-hidden opacity-0 transition-all duration-300 group-hover:w-full group-hover:opacity-100">
                ...
                <NavLink
                  ...
                  className={({ isActive }) =>
                    [
                      ...
                      "justify-center px-0 group-hover:justify-start group-hover:px-4 group-hover:gap-4",
                      isActive
                ...
                >
                  {({ isActive }) => (
                    <>
                      ...
                      <div className="min-w-0 flex-1 overflow-hidden">
                        <span className="pointer-events-none block w-0 overflow-hidden whitespace-nowrap text-sm font-medium opacity-0 transition-all duration-300 group-hover:w-full group-hover:opacity-100">
                          {item.label}
                        </span>
                      </div>
                      ...
                      <ChevronRight
                        className={[
                          "relative z-10 h-4 w-4 shrink-0 text-white/35 transition-all duration-300",
          ...
          {/* bottom profile */}
          <div className="p-3">
            <div className="flex items-center justify-center gap-3 rounded-[26px] border border-white/10 bg-white/[0.05] p-3 backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_10px_30px_rgba(0,0,0,0.18)] transition-all duration-300 group-hover:justify-start">
