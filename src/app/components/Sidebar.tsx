...
export default function Sidebar() {
  return (
    <aside className="relative h-full overflow-hidden border-r border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.10),rgba(255,255,255,0.04))] backdrop-blur-2xl shadow-[0_0_40px_rgba(88,28,255,0.10)]">
      ...
      <div className="relative flex h-full flex-col">
        <div className="px-4 pt-4 pb-5">
          <div className="flex items-center gap-3 rounded-[26px] border border-white/10 bg-white/[0.06] px-3 py-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.10),0_10px_30px_rgba(0,0,0,0.22)] backdrop-blur-xl">
            ...
            <div className="min-w-0 overflow-hidden">
              <h2 className="truncate text-[17px] font-semibold tracking-wide text-white opacity-0 translate-x-3 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
                Ridzhan SASS
              </h2>
              <p className="truncate text-xs text-white/45 opacity-0 translate-x-3 transition-all duration-300 delay-75 group-hover:translate-x-0 group-hover:opacity-100">
          ...
          <div className="space-y-2">
            {navItems.map((item) => (
              <NavLink
                ...
                className={({ isActive }) =>
                  `relative flex h-[58px] items-center rounded-2xl overflow-hidden transition-all duration-300 ${
                    isActive
                ...
                {({ isActive }) => (
                  <>
                    ...
                    <div className="relative z-10 flex min-w-0 flex-1 items-center justify-between pr-4">
                      <span className="truncate text-sm font-medium tracking-[0.02em] text-white/90 opacity-0 translate-x-2 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
                        {item.label}
                      </span>

                      <ChevronRight
                        className={`h-4 w-4 shrink-0 transition-all duration-300 opacity-0 translate-x-2 group-hover:translate-x-0 group-hover:opacity-100 ${
        ...
        <div className="p-3">
          <div className="rounded-[24px] border border-white/10 bg-white/[0.05] px-3 py-3 backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_10px_30px_rgba(0,0,0,0.18)]">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0 overflow-hidden">
                <p className="truncate text-sm font-medium text-white opacity-0 translate-x-2 transition-all duration-300 group-hover:translate-x-0 group-hover:opacity-100">
                  Ridzhan Admin
                </p>
                <p className="truncate text-xs text-white/45 opacity-0 translate-x-2 transition-all duration-300 delay-75 group-hover:translate-x-0 group-hover:opacity-100">
                  Gaming Club System
                </p>
              </div>
            </div>
