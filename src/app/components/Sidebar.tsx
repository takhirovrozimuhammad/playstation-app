          ...
          <div className="px-3 pb-3 pt-4">
            <div className="flex items-center gap-3 rounded-[26px] border border-white/10 bg-white/[0.06] p-3 backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.08),0_12px_30px_rgba(0,0,0,0.24)]">
              ...
              <div className="min-w-0 overflow-hidden">
                <h2
                  className={`truncate text-[17px] font-semibold tracking-[0.01em] text-white transition-all duration-200 ${textVisibilityClass}`}
                >
                  Ridzhan SASS
                </h2>
                <p
                  className={`truncate text-xs text-white/60 transition-all duration-200 delay-75 ${textVisibilityClass}`}
                >
                  Admin panel
                </p>
              </div>
                ...
                >
                  {({ isActive }) => (
                    <>
                      ...
                      <span
                        className={`relative z-10 whitespace-nowrap text-sm font-medium transition-all duration-200 ${textVisibilityClass}`}
                      >
                        {item.label}
                      </span>
          ...
          <div className="p-3" ref={controlRef}>
            <div className="relative">
              <button
                ...
                className="flex w-full items-center gap-3 rounded-[26px] border border-white/10 bg-white/[0.05] p-3 text-left backdrop-blur-xl shadow-[inset_0_1px_0_rgba(255,255,255,0.06),0_10px_30px_rgba(0,0,0,0.18)] transition-all duration-200 hover:bg-white/[0.08]"
              >
                ...
                <div className="min-w-0 overflow-hidden">
                  <p
                    className={`truncate text-sm font-medium text-white transition-all duration-200 ${textVisibilityClass}`}
                  >
                    Sidebar boshqaruvi
                  </p>
                  <p
              ...
              {controlOpen && (
                <div className="absolute bottom-[calc(100%+10px)] left-0 z-[70] w-[230px] overflow-hidden rounded-2xl border border-white/10 bg-[#1a1c22]/95 shadow-[0_18px_50px_rgba(0,0,0,0.45)] backdrop-blur-2xl">
                  ...
                  <div className="p-2">
                    <button
                      ...
                      className="flex w-full items-center justify-between rounded-xl px-3 py-2.5 text-sm text-white/80 transition hover:bg-white/5"
                    >
