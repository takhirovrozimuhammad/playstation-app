...
const navItems: NavItem[] = [
  ...
  { to: "/bookings", icon: BookOpen, label: "Band qilishlar" },
...
export default function Sidebar() {
  return (
    <aside
      ...
      "
      aria-label="Yon panel navigatsiyasi"
    >
        ...
        <div className="relative flex h-full flex-col">
          ...
          <div className="px-3 pb-3 pt-4">
            <NavLink
              to="/"
              className="
                flex items-center gap-3 rounded-[26px] border border-white/10
                bg-white/[0.06] p-3 backdrop-blur-xl
            ...
            >
              ...
              <div className="min-w-0 flex-1 overflow-hidden opacity-0 transition-all duration-200 group-hover:opacity-100">
            ...
            <div className="space-y-2">
              {navItems.map((item) => (
                <NavLink
                  ...
                  className={({ isActive }) =>
                    [
                      "relative flex h-14 items-center overflow-hidden rounded-2xl border transition-all duration-200 ease-out",
                ...
                >
                  {({ isActive }) => (
                    <>
                      {isActive && (
                        <>
                          <div className="absolute left-0 top-1/2 hidden h-8 w-[3px] -translate-y-1/2 rounded-r-full bg-gradient-to-b from-fuchsia-400 to-cyan-400 shadow-[0_0_14px_rgba(34,211,238,0.85)] group-hover:block" />
                      ...
                      <div className="relative z-10 flex w-[88px] shrink-0 items-center justify-center group-hover:w-6">
                        <item.icon
                          className={[
                      ...
                      <span className="relative z-10 hidden whitespace-nowrap text-sm font-medium opacity-0 transition-all duration-200 group-hover:block group-hover:opacity-100">
                        {item.label}
                      </span>

                      <ChevronRight
                        className={[
                          "relative z-10 ml-auto hidden h-4 w-4 shrink-0 transition-all duration-200 group-hover:block",
